...
class BookRV(val item:List<ListBook>, val context: Context,val reviewsViewModel: ReviewsViewModel,val lifecycleOwner: LifecycleOwner): RecyclerView.Adapter<BookRV.ViewHolder>() {
